...
function of_recognized_background_repeat() {
	...
	$default = array(
		'no-repeat' => __( 'No Repeat', 'skt_white' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'skt_white' ),
		'repeat-y'  => __( 'Repeat Vertically', 'skt_white' ),
		'repeat'    => __( 'Repeat All', 'skt_white' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'skt_white' ),
		'top center'    => __( 'Top Center', 'skt_white' ),
		'top right'     => __( 'Top Right', 'skt_white' ),
		'center left'   => __( 'Middle Left', 'skt_white' ),
		'center center' => __( 'Middle Center', 'skt_white' ),
		'center right'  => __( 'Middle Right', 'skt_white' ),
		'bottom left'   => __( 'Bottom Left', 'skt_white' ),
		'bottom center' => __( 'Bottom Center', 'skt_white' ),
		'bottom right'  => __( 'Bottom Right', 'skt_white')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'skt_white' ),
		'fixed'  => __( 'Fixed in Place', 'skt_white')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'skt_white' ),
		'italic'      => __( 'Italic', 'skt_white' ),
		'bold'        => __( 'Bold', 'skt_white' ),
		'bold italic' => __( 'Bold Italic', 'skt_white' )
		);
